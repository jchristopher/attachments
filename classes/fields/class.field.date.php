...
class Attachments_Field_Date extends Attachments_Field
{
     ...
     */
    function __construct( $name = 'date', $label = 'Date', $value = null, $meta = array() )
    {
    ...
    {
    ?>
        <input type="date" name="<?php esc_attr_e( $field->field_name ); ?>" id="<?php esc_attr_e( $field->field_id ); ?>" class="attachments attachments-field attachments-field-<?php esc_attr_e( $field->field_name ); ?> attachments-field-<?php esc_attr_e( $field->field_id ); ?>" value="<?php esc_attr_e( $field->value ); ?>" data-default="<?php esc_attr_e( $field->default ); ?>" />
    <?php
    }
